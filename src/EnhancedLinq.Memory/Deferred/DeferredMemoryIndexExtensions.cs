...
/// <summary>
/// </summary>
public static class DeferredMemoryIndexExtensions
{
    ...
    {
        /// <summary>
        ///     Returns a sequence of indices of all elements within the given <see cref="Memory{T}" />, starting from an initial
        ///     index of zero.
        /// </summary>
        /// <returns>
        ///     A sequence of integers representing the indices of the elements in the <see cref="Memory{T}" /> starting from
        ///     index zero.
        /// </returns>
    ...
    {
        /// <summary>
        ///     Returns a sequence of indices of all elements within the given <see cref="ReadOnlyMemory{T}" />, starting from an
        ///     initial index of zero.
        /// </summary>
        /// <returns>
        ///     A sequence of integers representing the indices of the elements in the <see cref="ReadOnlyMemory{T}" />
