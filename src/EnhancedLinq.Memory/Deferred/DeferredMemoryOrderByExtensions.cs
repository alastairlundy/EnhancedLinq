...
/// <summary>
/// </summary>
public static class DeferredMemoryOrderByExtensions
{
    ...
    extension<TSource>(Memory<TSource> source)
    {
        ...
        {
            return source.OrderBy(predicate, Comparer<TKey>.Default);
        }
        ...
        /// <returns>
        ///     An <see cref="IOrderedEnumerable{TElement}" /> whose elements are sorted in descending order according to the
        ///     specified key.
        /// </returns>
        public IOrderedEnumerable<TSource> OrderByDescending<TKey>(Func<TSource, TKey> predicate)
        {
            return source.OrderByDescending(predicate, Comparer<TKey>.Default);
        }
    ...
    extension<TSource>(ReadOnlyMemory<TSource> source)
    {
        ...
        /// <param name="predicate">A function that extracts the key for each element.</param>
        /// <param name="comparer">
        ///     An optional comparer to be used for comparing keys. If null, the default comparer for type
        ///     <typeparamref name="TKey" /> is used.
        /// </param>
        /// <returns>
        ///     An <see cref="IOrderedEnumerable{TSource}" /> whose elements are sorted in descending order according to the
        ///     specified key.
        /// </returns>
        public IOrderedEnumerable<TSource> OrderByDescending<TKey>(Func<TSource, TKey> predicate,
            IComparer<TKey>? comparer)
