...
/// <summary>
/// </summary>
public static class DeferredMemoryWhereExtensions
{
    /// <summary>
    /// </summary>
    ...
    extension<T>(Memory<T> source)
    {
        ...
        ///     A function that evaluates each element to determine if it should be included in the returned
        ///     sequence.
        /// </param>
    ...
    extension<T>(ReadOnlyMemory<T> source)
    {
        ...
        /// <returns>
        ///     An <see cref="IEnumerable{T}" /> that contains elements from the <see cref="ReadOnlyMemory{T}" /> segment that
