...
/// <summary>
/// </summary>
public static class ImmediateMemoryIndicesExtensions
{
    ...
    extension<T>(ReadOnlySpan<T> source) where T : notnull
    {
        ...
        /// <summary>
        ///     Gets a collection of indices within the given <see cref="ReadOnlySpan{T}" /> where items match the predicate
        ///     condition.
        /// </summary>
        /// <param name="predicate">The predicate to use to select items to retrieve the index of.</param>
        /// <returns>
        ///     A collection of indices that represent all items in the <see cref="ReadOnlySpan{T}" /> that match the
        ///     predicate.
        /// </returns>
        public ICollection<int> IndicesOf(Func<T, bool> predicate)
        {
