...
public static class ImmediateMemoryCountAtLeastExtensions
{
    ...
    extension<T>(Span<T> source)
    {
        ...
        /// <returns>
        ///     <c>true</c> if there is at least the specified number of elements in the <see cref="Span{T}" />; otherwise,
        ///     <c>false</c>.
        /// </returns>
        ...
        /// <summary>
        ///     Determines whether there are at least a specified number of elements in the <see cref="Span{T}" /> that meet a
        ///     given condition.
        /// </summary>
        /// <param name="predicate">The predicate condition to check elements against.</param>
        /// <param name="countToLookFor">The minimum count to look for.</param>
        /// <returns>
        ///     <c>true</c> if there are at least the specified number of elements that meet the condition; otherwise,
        ///     <c>false</c>.
        /// </returns>
    ...
    extension<T>(ReadOnlySpan<T> source)
    {
        ...
        /// <param name="countToLookFor">The minimum count to look for.</param>
        /// <returns>
        ///     <c>true</c> if there is at least the specified number of elements in the <see cref="ReadOnlySpan{T}" />;
        ///     otherwise, <c>false</c>.
        /// </returns>
        public bool CountAtLeast(int countToLookFor)
        {
        ...
        /// <summary>
        ///     Determines whether there are at least a specified number of elements in the <see cref="ReadOnlySpan{T}" /> that
        ///     meet a given condition.
        /// </summary>
        /// <param name="predicate">The predicate condition to check elements against.</param>
        /// <param name="countToLookFor">The minimum count to look for.</param>
        /// <returns>
        ///     <c>true</c> if there are at least the specified number of elements in the <see cref="ReadOnlySpan{T}" />
        ///     that meet the condition; otherwise, <c>false</c>.
        /// </returns>
        public bool CountAtLeast(Func<T, bool> predicate,
            int countToLookFor)
        {
    ...
    extension<T>(Memory<T> source)
    {
        ...
        /// <param name="countToLookFor">The minimum count to look for.</param>
        /// <returns>
        ///     <c>true</c> if there is at least the specified number of elements in the <see cref="Memory{T}" />; otherwise,
        ///     <c>false</c>.
        /// </returns>
        public bool CountAtLeast(int countToLookFor)
        {
        ...
        /// <summary>
        ///     Determines whether there are at least a specified number of elements in the <see cref="Memory{T}" /> that meet a
        ///     given condition.
        /// </summary>
        /// <param name="predicate">The predicate condition to check elements against.</param>
        /// <param name="countToLookFor">The minimum count to look for.</param>
        /// <returns>
        ///     <c>true</c> if there are at least the specified number of elements in the <see cref="Memory{T}" /> that meet
        ///     the condition; otherwise, <c>false</c>.
        /// </returns>
        public bool CountAtLeast(Func<T, bool> predicate,
            int countToLookFor)
        {
    ...
    extension<T>(ReadOnlyMemory<T> source)
    {
        ...
        /// <param name="countToLookFor">The minimum count to look for.</param>
        /// <returns>
        ///     <c>true</c> if there is at least the specified number of elements in the <see cref="ReadOnlyMemory{T}" />;
        ///     otherwise, <c>false</c>.
        /// </returns>
        public bool CountAtLeast(int countToLookFor)
        {
        ...
        /// <summary>
        ///     Determines whether there are at least a specified number of elements in the <see cref="ReadOnlyMemory{T}" /> that
        ///     meet a given condition.
        /// </summary>
        /// <param name="predicate">The predicate condition to check elements against.</param>
        /// <param name="countToLookFor">The minimum count to look for.</param>
        /// <returns>
        ///     <c>true</c> if there are at least the specified number of elements in the <see cref="ReadOnlyMemory{T}" />
        ///     that meet the condition; otherwise, <c>false</c>.
        /// </returns>
        public bool CountAtLeast(Func<T, bool> predicate,
            int countToLookFor)
