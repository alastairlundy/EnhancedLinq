...
/// <summary>
/// </summary>
public static class ImmediateMemoryCountAtMostExtensions
{
    ...
    extension<T>(Span<T> source)
    {
        ...
        /// <summary>
        ///     Determines whether there are at most a maximum number of elements in the source <see cref="Span{T}" /> that satisfy
        ///     the given condition.
        /// </summary>
        /// <param name="predicate">The predicate condition to check elements against.</param>
        /// <param name="countToLookFor">The maximum number of elements that can meet the condition.</param>
        /// <returns>
        ///     True if there are at most <paramref name="countToLookFor" /> number of elements that satisfy the condition,
        ///     false otherwise.
        /// </returns>
    ...
    /// <param name="source">The source <see cref="ReadOnlySpan{T}" /> to search through.</param>
    /// <typeparam name="T">The element type of the source <see cref="ReadOnlySpan{T}" />.</typeparam>
    extension<T>(ReadOnlySpan<T> source)
    {
        /// <summary>
        ///     Determines whether there are at most a maximum number of elements in the source <see cref="ReadOnlySpan{T}" />.
        /// </summary>
        /// <param name="countToLookFor">The maximum number of elements that can meet the condition.</param>
        /// <returns>True if there are at most <paramref name="countToLookFor" /> number of elements, false otherwise.</returns>
        public bool CountAtMost(int countToLookFor)
        ...
        /// <summary>
        ///     Determines whether there are at most a maximum number elements in the source <see cref="Span{T}" /> that satisfy
        ///     the given condition.
        /// </summary>
        /// <param name="predicate">The predicate condition to check elements against.</param>
        /// <param name="countToLookFor">The maximum number of elements that can meet the condition.</param>
    ...
    extension<T>(Memory<T> source)
    {
        ...
        /// <param name="countToLookFor">The maximum number of elements that can meet the condition.</param>
        /// <returns>
        ///     True if there are at most <paramref name="countToLookFor" /> number of elements in the
        ///     <see cref="Memory{T}" />, false otherwise.
        /// </returns>
        public bool CountAtMost(int countToLookFor)
        {
            ArgumentOutOfRangeException.ThrowIfNegative(countToLookFor);
        ...
        /// <summary>
        ///     Determines whether there are at most a maximum number of elements in the source <see cref="Memory{T}" /> that
        ...
        /// <returns>
        ///     True if there are at most <paramref name="countToLookFor" /> number of elements in the
        ///     <see cref="Memory{T}" /> that satisfy the condition, false otherwise.
        /// </returns>
        public bool CountAtMost(Func<T, bool> predicate,
            int countToLookFor)
        {
