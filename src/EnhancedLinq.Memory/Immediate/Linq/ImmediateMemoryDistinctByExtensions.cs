...
/// <summary>
/// </summary>
public static class ImmediateMemoryDistinctByExtensions
{
    /// <summary>
    /// </summary>
    ...
    extension<TSource>(Span<TSource> source)
    {
        ...
        /// <param name="keySelector">A function to extract a key from an element.</param>
        /// <param name="comparer">
        ///     An equality comparer to compare keys. If null, the default equality comparer for the key type is
        ///     used.
        /// </param>
        /// <returns>A span that contains only the distinct elements from the source span, determined by the key selector.</returns>
        /// <exception cref="InvalidOperationException">Thrown when the source span is empty.</exception>
        ...
        public Span<TSource> DistinctBy<TKey>(Func<TSource, TKey> keySelector, IEqualityComparer<TKey>? comparer)
        {
            ...
            HashSet<TKey> allowedKeys = new(comparer);
    ...
    extension<TSource>(ReadOnlySpan<TSource> source)
    {
        ...
        ///     <see cref="ReadOnlySpan{T}" />, determined by a specified key selector.
        /// </summary>
        /// <typeparam name="TKey">The type of the key extracted from each element.</typeparam>
        /// <param name="keySelector">A function to extract a key from an element.</param>
        /// <returns>
        ...
        /// <summary>
        ///     Returns a new <see cref="ReadOnlySpan{T}" /> containing only the distinct elements from the source
        ///     <see cref="ReadOnlySpan{T}" />, determined by a specified key selector and an optional equality comparer.
        /// </summary>
        /// <typeparam name="TKey">The type of the key extracted from each element.</typeparam>
    ...
    extension<TSource>(Memory<TSource> source)
    {
        ...
        /// <summary>
        ///     Returns a new memory segment containing only the distinct elements from the source memory, determined by a
        ///     specified key selector and an optional equality comparer.
        /// </summary>
        /// <typeparam name="TKey">The type of the key extracted from each element.</typeparam>
        /// <param name="keySelector">A function to extract a key from an element.</param>
        /// <param name="comparer">
        ///     An optional comparer to determine the equality of keys. If null, the default equality comparer
    ...
    {
        /// <summary>
        ///     Returns a new <see cref="ReadOnlyMemory{T}" /> block containing only the distinct elements from the source
        ///     <see cref="ReadOnlyMemory{T}" /> block, determined by a specified key selector.
        /// </summary>
        /// <typeparam name="TKey">The type of the key extracted from each element.</typeparam>
        /// <param name="keySelector">A function to extract a key from an element.</param>
        /// <returns>
        ...
        ///     <see cref="ReadOnlyMemory{T}" />, determined by a specified key selector and optional equality comparer.
        /// </summary>
        /// <typeparam name="TKey">The type of the key extracted from each element.</typeparam>
        /// <param name="keySelector">A function to extract a key from an element of the source <see cref="ReadOnlyMemory{T}" />.</param>
        /// <param name="comparer">
        ///     An optional equality comparer to compare keys. If null, the default equality comparer for the type
