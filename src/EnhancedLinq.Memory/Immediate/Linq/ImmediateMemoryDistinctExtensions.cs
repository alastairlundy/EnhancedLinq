...
/// <summary>
/// </summary>
public static class ImmediateMemoryDistinctExtensions
{
    private static T[] DistinctArray<T>(Span<T> source, IEqualityComparer<T>? comparer)
    {
        ...
        HashSet<T> set = new(source.Length, comparer);
#else
    ...
    extension<T>(Span<T> source)
    {
        ...
        {
            return DistinctArray(source, EqualityComparer<T>.Default);
        }
        ...
        {
            return DistinctArray(source, comparer);
        }
    }
    ...
    {
        /// <summary>
        ///     Returns a new <see cref="ReadOnlySpan{T}" /> containing distinct elements from the source
        ///     <see cref="ReadOnlySpan{T}" />, using the default equality comparer.
        /// </summary>
        /// <returns>
        ///     A <see cref="ReadOnlySpan{T}" /> containing the distinct elements from the source
    ...
    {
        /// <summary>
        ///     Returns a new <see cref="Memory{T}" /> containing distinct elements from the source <see cref="Memory{T}" />, using
        ...
        {
            return DistinctArray(source.Span, EqualityComparer<T>.Default);
        }
        ...
        /// </summary>
        /// <param name="comparer">
        ///     The equality comparer to use for determining distinct elements. If null, the default equality
        ///     comparer is used.
        /// </param>
        /// <returns>A <see cref="Memory{T}" /> containing the distinct elements from the source <see cref="Memory{T}" />.</returns>
        public Memory<T> Distinct(IEqualityComparer<T>? comparer)
        {
            return DistinctArray(source.Span, comparer);
        }
    }
    ...
    {
        /// <summary>
        ///     Returns a new <see cref="ReadOnlyMemory{T}" /> containing distinct elements from the source
        ///     <see cref="ReadOnlyMemory{T}" />, using the default equality comparer.
        /// </summary>
        /// <returns>
        ///     A <see cref="ReadOnlyMemory{T}" /> containing the distinct elements from the source
        ...
        /// <summary>
        ///     Returns a new <see cref="ReadOnlyMemory{T}" /> containing distinct elements from the source
        ///     <see cref="ReadOnlyMemory{T}" />, using the specified equality comparer.
        /// </summary>
        /// <param name="comparer">
        ///     The equality comparer to use for determining distinct elements. If null, the default equality
        ///     comparer is used.
