...
/// <summary>
/// </summary>
public static class ImmediateMemoryElementsAtExtensions
{
    ...
    extension<T>(Memory<T> source)
    {
        ...
        /// <returns>
        ///     A new source <see cref="Memory{T}" /> containing a single element starting at the specified index in the
        ///     Memory.
        /// </returns>
        /// <exception cref="ArgumentOutOfRangeException">
        ///     Thrown if the source <see cref="Memory{T}" /> has no elements or the
        ...
        /// <param name="index">The zero-based index of the element to be retrieved.</param>
        /// <returns>
        ///     The element at the specified index in the source <see cref="Memory{T}" /> if found;
    ...
    extension<T>(ReadOnlyMemory<T> source)
    {
        ...
        /// <param name="index">The zero-based index of the element to be retrieved.</param>
        /// <returns>
        ///     A new source <see cref="ReadOnlyMemory{T}" /> containing a single element starting at the specified index in
        ///     the Memory.
        /// </returns>
        /// <exception cref="ArgumentOutOfRangeException">
        ///     Thrown if the source <see cref="ReadOnlyMemory{T}" /> has no elements or
        ...
        /// <param name="index">The zero-based index of the element to be retrieved.</param>
        /// <returns>
        ///     The element at the specified index in the source <see cref="ReadOnlyMemory{T}" /> if found;
        ///     otherwise, the default value of type <typeparamref name="T" />.
        /// </returns>
        public T? ElementAtOrDefault(int index)
        {
        ...
        /// <summary>
        ///     Returns a new <see cref="ReadOnlyMemory{T}" /> containing the specified number of elements starting at the
        ///     specified index.
        /// </summary>
        /// <param name="index">The zero-based index of the element to be retrieved.</param>
        /// <param name="count">The number of elements to include in the returned Memory.</param>
        /// <returns>
        ///     A new <see cref="ReadOnlyMemory{T}" /> containing the specified number of elements starting at the specified
        ///     index.
        /// </returns>
        /// <exception cref="ArgumentOutOfRangeException">
        ///     Thrown if the source <see cref="ReadOnlyMemory{T}" /> has no elements or
    ...
    {
        /// <summary>
        ///     Returns the element at the specified index in the source <see cref="Span{T}" /> or the default value of type
        ///     <typeparamref name="T" /> if the index is out of range.
        /// </summary>
        /// <param name="index">The zero-based index of the element to retrieve.</param>
        /// <returns>
        ///     The element at the specified index in the source <see cref="Span{T}" />, or the default value of type
        ///     <typeparamref name="T" /> if the index is out of range.
        /// </returns>
        public T? ElementAtOrDefault(int index)
        {
        ...
        /// <summary>
        ///     Returns a contiguous segment of elements from the source <see cref="Span{T}" /> starting at the specified index and
    ...
    {
        /// <summary>
        ///     Returns the element at the specified index from the source <see cref="ReadOnlySpan{T}" />, or the default value for
        ///     the type if the index is out of range.
        /// </summary>
        /// <param name="index">The zero-based index of the element to retrieve.</param>
        ...
        /// <summary>
        ///     Retrieves a continuous range of elements starting at a specified index and spanning a specified count from the
        ///     source <see cref="ReadOnlySpan{T}" />.
        /// </summary>
        ...
        /// <exception cref="ArgumentOutOfRangeException">
        ///     Thrown if the source <see cref="ReadOnlySpan{T}" /> is empty, or if the <paramref name="index" /> or
        ///     <paramref name="count" /> values are less than or equal to zero.
        /// </exception>
