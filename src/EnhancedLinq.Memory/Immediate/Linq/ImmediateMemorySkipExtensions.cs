...
public static class ImmediateMemorySkipExtensions
{
    ...
    extension<T>(Span<T> target)
    {
        ...
        public Span<T> Skip(int count)
        {
            ...
            return target.Slice(count, target.Length - count);
        }
    ...
    {
        /// <summary>
        ///     Returns a new read-only span with all the elements of the original span except the specified first number of
        ///     elements.
        /// </summary>
        /// <param name="count">The number of items to skip from the beginning of the span.</param>
        ...
        /// <summary>
        ///     Returns a new span with all the elements of the original span except for the specified number of elements from the
        ///     end.
        /// </summary>
        ...
        ///     Thrown when the specified count is negative or greater than the span's
        ///     length.
        /// </exception>
        ...
        /// <summary>
        ///     Returns a new <see cref="ReadOnlySpan{T}" /> containing the elements of the original span starting from the first
        ///     element
