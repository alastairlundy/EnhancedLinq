...
/// <summary>
/// </summary>
public static class ImmediateMemoryIndexExtensions
{
    ...
    {
        /// <summary>
        ///     Returns a collection of indices of all elements within the given <see cref="ReadOnlySpan{T}" />, starting from an
