...
/// <summary>
/// </summary>
public static class ImmediateMemoryTakeExtensions
{
    ...
    extension<T>(ReadOnlySpan<T> source)
    {
        ...
        /// <param name="count">The number of elements to take.</param>
        /// <returns>
        ///     A <see cref="ReadOnlySpan{T}" /> containing the first 'count' elements from the <see cref="ReadOnlySpan{T}" />
        ///     .
        /// </returns>
        /// <exception cref="ArgumentException">
        ///     Thrown when the count is less than zero or greater than the length of the
        ...
        /// <summary>
        ///     Returns elements from the <see cref="ReadOnlySpan{T}" /> as long as the predicate condition matches elements in the
        ///     <see cref="ReadOnlySpan{T}" />.
        /// </summary>
        ...
        /// <exception cref="ArgumentException">
        ///     Thrown when the count is less than 0 or greater than the length of the
        ///     <see cref="ReadOnlySpan{T}" />.
        /// </exception>
